...
export class ErrorCode {
  ...
  static readonly FORBIDDEN = new ErrorCode('토큰에 문제가 발생했습니다. 다시 시도해주세요.', HttpStatus.FORBIDDEN);
  static readonly NOT_EXIST_BROAD = new ErrorCode('존재하지 않는 게시글입니다.', HttpStatus.NOT_FOUND);
